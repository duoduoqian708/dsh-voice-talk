...
function WhaleMark(): ReactElement {
  return (
    <svg className='dsh-voice-whale' width='34' height='25' viewBox='0 0 23.16 17.04' fill='none' aria-hidden='true'>
...
function Avatar({ useVoice }: { useVoice: VoiceSelectorHook }): ReactElement {
  ...
  return (
    <div className='dsh-voice-avatar-wrap' data-phase={phase}>
      ...
      <div className='dsh-voice-avatar-circle'>
        <WhaleMark />
      </div>
    </div>
  )
