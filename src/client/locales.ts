...
export const zh = {
  ...
  'theme.asrQwenNote': '与「说」共用同一 DashScope API Key',
  'theme.asrQwenPrice': '按有效语音 0.00033 元/秒（静音不计费）',
  ...
  'modal.done': '完成',
  'modal.register': '申请 API Key ↗',
  'modal.billingLink': '查看阿里云用量与账单详情（需登录）',
  'modal.model': '模型 ID',
  'modal.endpoint': '接口地址',
  'modal.try': '试听',
  ...
  'err.asrNoLink': '语音识别连接超时，请检查网络后重试',
  'err.asrAudio': '识别音频未能启动（浏览器音频上下文未运行）',
  'err.asrUnreachable': '连不上语音识别服务（已重试多次）',
  'err.playback': '音频播放失败',
...
export const en: Record<VoiceKey, string> = {
  ...
  'theme.asrQwenPrice': '¥0.00033 per second of speech (silence is free)',
  ...
  'modal.done': 'Done',
  'modal.register': 'Get an API Key ↗',
  'modal.billingLink': 'View Alibaba Cloud usage & billing (sign-in required)',
  ...
  'hud.rateTitle': 'Rate (this call only)',
  ...
  'err.asrNoLink': 'Speech recognition connection timed out — check your network and retry',
  'err.asrAudio': 'Recognition audio failed to start (browser audio context not running)',
  'err.asrUnreachable': 'Cannot reach the speech recognition service (retried several times)',
